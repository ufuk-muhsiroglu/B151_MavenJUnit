...
public class C01_Cookies extends TestBase {
    ...
    public void test01() {
        ...
        cookieSet = driver.manage().getCookies();// tekrar cookie seti guncelledik
        Assert.assertTrue(cookieSet.isEmpty()); // cookie set icinin bos oldugunu isEmpty methodu ile test ettik.
    }
}